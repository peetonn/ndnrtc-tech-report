...
%% PG:
%% TODO: review section 6.3 last paragraph for duplication of the paragraph below
...
\subfigure[$W=4$: longer chasing, smaller $RTT^\prime$]{\label{fig:ws10}\def\svgwidth{0.48\textwidth}\input{w4.pdf_tex}}
\subfigure[$W=3$: consumer can't exhasut cache, $RTT^\prime = RTT$]{\label{fig:ws10}\def\svgwidth{0.48\textwidth}\input{w3.pdf_tex}}
\end{scriptsize}
