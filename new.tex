...
%************************************************
\abstract
\emph{ndnrtc} is a fully implemented real-time videoconferencing library based on the WebRTC library and VP8 codec, which has been developed to understand the challenges of low-latency communication over information-centric networks. Through it an NDN-inspired pull-based paradigm has been explored, evaluated and presented in this paper.
