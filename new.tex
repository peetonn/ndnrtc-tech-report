...
%%% *** BUT how are we different from VoCCN?  What did we learn *** %%% 
...
The consumer implements Interest pipelining and data buffering, as shown in Figure \ref{fig:consumer}. %, to fetch and reassemble video and audio data while allowing for out-of-order arrival and interest reexpression. 
