...
\centering
\begin{tiny}
\subfigure[window 4]{\def\svgwidth{0.5\textwidth}\input{w4.pdf_tex}}
\subfigure[window 5]{\def\svgwidth{0.5\textwidth}\input{w5.pdf_tex}}
\end{tiny}
...
% \begin{itemize}
% \item cached data on the network
% \item main cache data indicatior - inter-arrival delays
% \item increasing the number of outstanding interests helps exhaust network cache
% \item changes in $RTT^{\prime}$ react to changes in the number of outstanding interests
% \item $RTT^{\prime}$ hits minimum for the cached data
% \item interests are issued in bursts - per frame
% \end{itemize}
